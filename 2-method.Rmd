...
A Reproducibile analysis is an analysis with results that can be generated directly from raw data anywhere by anybody [@berez-kroeker2018]. Besides rerunning analysis to generate results every time, two other features make R Markdown a good tool for facilitating a reproducible workflow:
...
By using R extensions, or R packages, R Markdown can be turned into a specialized tool for writing Linguistics related documents.
