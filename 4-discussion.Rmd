...
However, there are instances where no LaTeX templates exist. For example, *Chinese Journal of Psychology* doesn't provide any template and only accepts submission in MS Word format.
This problem can be fixed by using the MS Word output (`.docx`) provided by R Markdown. A Word template can also be set up manually [@layton2015].
